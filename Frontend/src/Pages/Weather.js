...
//   return (
//     <nav className={`navbar navbar-expand-lg navbar-light ${weatherData.isDay ? "day" : "night"}`}>
...
//               />
//               <i className="bi bi-search search-icon" onClick={() => search(document.querySelector(".form-control.input").value)}></i>
//             </li>
