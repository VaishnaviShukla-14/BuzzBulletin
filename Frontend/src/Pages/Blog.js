...
const Blog = () => {
  return (
   ...
   <p>Welcome to our vibrant community of bloggers! We're thrilled to invite you to join us in sharing your thoughts, experiences, and passions through the power of blogging.
...
<div class="gallery" id="Gallery">
  ...
  <div class="gallery_image_box">
    <div class="gallery_image">
      <img src="Images/Ram_mandir.jpg"/>
     
      <h3>The Ram Mandir Celebration</h3>

      <a href="#" class="gallery_btn">Explore Now!</a>
      
    </div>


    <div class="gallery_image">
      <img src="Images/modiji.jpg"/>
    ...
    <div class="gallery_image">
      <img src="Images/russia_ukraine.jpg"  style={{height:'650px'}}/>
      <h3>Russia Ukraine Feud</h3>
    ...
    <div class="gallery_image">
      <img src="Images/american_presidents.jpg" style={{height:'650px'}}/>
      <h3>Who's Better?</h3>
    ...
    <div class="gallery_image">
      <img src="Images/ipl.jpg" style={{height:'650px'}}/>
      <h3>IPL 2024</h3>
  ...
  <div class="review_box">
    <div class="review_card">
      ...
      <div class="review_profile">
        <img src="https://i.pinimg.com/564x/2d/5c/a1/2d5ca1de2e6bd46e42f772464da61828.jpg"/>
      </div>

      <div class="review_text">
        <h2 class="name">The Lakshwadeep Diaries</h2>
